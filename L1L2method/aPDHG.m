%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%This function performs accelerated PDHG with dynamic 
%step size to solve for u for each iteration of the DCA algorithm
%
%Input:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function u = aPDHG(u0,r, alpha, lambda, c, inner_iter, tau, sigma)
    %obtain size
    [rows, cols] = size(u0);
    ...
    for i=1:inner_iter
        ...
        %update extrapolation parameters and step sizes
